...
{
    class ZugDeckungsSignalSchirm : public ISignalSchirm, public IModifySignalSchirm
    {
    public:
        ZugDeckungsSignalSchirm();
    ...
    protected:
        ZugDeckungsSignalBild m_signalBild{ZugDeckungsSignalBild::Off};
        KennLichtState m_kennLichtState{KennLichtState::On};
    };
}
